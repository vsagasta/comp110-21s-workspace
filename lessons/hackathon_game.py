"""An 8 ball game to provide you the answers to life's most ardent questions."""
...
def main() -> None:
    ...
    while playing:
        question: str = input(f" {name}, ask the magic oracle a yes or no question: ")
        random_number: int = randint(0, 10)
        print(answer(random_number))
        playing = input("Continue asking questions? yes / no ") == "yes"
...
def answer(n: int) -> str:
    ...
    if n == 0:
        ...
        # please visit this link if you are confused about the reference made in this oracle answer.
        # https://www.youtube.com/watch?v=CqCCBohjaqA
    elif n == 8:
